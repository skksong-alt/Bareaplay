...
test('worker installation does not replace editing clients or preload admin bundles',async()=>{
    ...
    const sandbox={URL,Promise,console,fetch:async()=>({ok:true,clone(){return this;}}),
        ...
        caches:{open:async()=>({add:async url=>cached.push(url),put:async()=>{}}),keys:async()=>['bareaplay-cache-old','bareaplay-cache-v73'],delete:async key=>removed.push(key),match:async()=>null}};
    ...
    assert.ok(cached.includes('/js/modules/votePage.js?v=13'));
