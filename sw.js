// sw.js
const CACHE_NAME = 'bareaplay-cache-v72';
const urlsToCache = [
    ...
    '/js/modules/lineupGenerator.js?v=10',
    '/js/modules/accounting.js?v=7',
    '/js/modules/shareManagement.js?v=11',
    '/js/modules/voteManagement.js?v=22',
