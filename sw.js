// sw.js
const CACHE_NAME = 'bareaplay-cache-v67';
const urlsToCache = [
    ...
    '/js/modules/voteManagement.js?v=17',
    ...
    '/js/modules/positionPreferences.js?v=3',
    '/js/modules/positionPreferencesCore.js?v=2',
    '/js/modules/weeklyContent.js?v=4',
    '/js/modules/votePage.js?v=9',
