// sw.js
const CACHE_NAME = 'bareaplay-cache-v74';
const urlsToCache = [
    ...
    '/js/modules/lineupGenerator.js?v=12',
    '/js/modules/accounting.js?v=9',
    '/js/modules/shareManagement.js?v=13',
    '/js/modules/voteManagement.js?v=24',
