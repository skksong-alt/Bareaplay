// sw.js
const CACHE_NAME = 'bareaplay-cache-v66';
const urlsToCache = [
    '/', '/index.html', '/share.html', '/css/style.css',
    '/css/match-hub.css?v=4',
    '/js/app.js?v=22',
    '/js/store.js?v=2',
    ...
    '/js/modules/voteManagement.js?v=16',
