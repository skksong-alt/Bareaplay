// sw.js
const CACHE_NAME = 'bareaplay-cache-v68';
const urlsToCache = [
    ...
    '/js/modules/voteManagement.js?v=18',
    ...
    '/js/modules/positionPreferences.js?v=4',
    '/js/modules/positionPreferencesCore.js?v=3',
    '/js/modules/weeklyContent.js?v=4',
    '/js/modules/votePage.js?v=10',
    '/js/modules/ratingIdentity.js?v=1',
    '/js/modules/ratingService.js?v=2',
